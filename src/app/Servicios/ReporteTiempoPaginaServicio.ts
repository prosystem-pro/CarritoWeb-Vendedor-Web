...
export class ReporteTiempoPaginaServicio {
  private Url = `${Entorno.ApiUrl}reportetiempopagina`; 
 ...
 Crear(Datos: any): Observable<any> {
  ...
  Editar(Datos: any): Observable<any> {
    return this.http.put(`${this.Url}/editar/${Datos.CodigoReporteTiempoPagina}`, Datos);
  }
